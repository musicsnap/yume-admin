            ...
            <div class="col-md-12">
                <div class="portlet box red">
                    ...
                    <div class="portlet-body form">
                        ...
                        @endif
                        <form action="{{url('admin/role')}}" id="roleForm" class="form-horizontal" method="post">
                            {!!csrf_field()!!}
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" class="form-control" name="display_name" placeholder="显示名称">
                                    </div>
                                </div>
                                <div class="form-group">
