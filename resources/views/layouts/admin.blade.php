...
<head>
    ...
    <link href="{{asset('backend/pages/css/error.min.css')}}" rel="stylesheet" type="text/css" />
    <link href="{{asset('backend/layouts/layout4/css/layout.min.css')}}" rel="stylesheet" type="text/css" />
    <link href="{{asset('backend/layouts/layout4/css/themes/light.min.css')}}" rel="stylesheet" type="text/css" id="style_color" />
...
<div class="page-header navbar navbar-fixed-top">
    <div class="page-header-inner ">
        <div class="page-logo">
            <a href="index.html">
                <img src="{{asset('backend/layouts/layout4/img/logo-light.png')}}" alt="logo" class="logo-default" /> </a>
                ...
                <ul class="nav navbar-nav pull-right">
                            ...
                            <li>
                                <ul class="dropdown-menu-list scroller" style="height: 275px;" data-handle-color="#637283">
                                    <li>
                                        <a href="#">
                                                    <span class="photo">
                                                        <img src="{{asset('backend/layouts/layout3/img/avatar2.jpg')}}" class="img-circle" alt=""> </span>
                                            <span class="subject">
                                    ...
                                    <li>
                                        <a href="#">
                                                    <span class="photo">
                                                        <img src="{{asset('backend/layouts/layout3/img/avatar3.jpg')}}" class="img-circle" alt=""> </span>
                                            <span class="subject">
                                    ...
                                    <li>
                                        <a href="#">
                                                    <span class="photo">
                                                        <img src="{{asset('backend/layouts/layout3/img/avatar1.jpg')}}" class="img-circle" alt=""> </span>
                                            <span class="subject">
                    ...
                    <li class="dropdown dropdown-user dropdown-dark">
                        <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                            ...
                            <img alt="" class="img-circle" src="{{asset('backend/layouts/layout4/img/avatar9.jpg')}}" /> </a>
                    ...
                    <div class="page-quick-sidebar-chat-users" data-rail-color="#ddd" data-wrapper-class="page-quick-sidebar-list">
                        ...
                        <ul class="media-list list-items">
                            <li class="media">
                                ...
                                <img class="media-object" src="{{asset('backend/layouts/layout/img/avatar3.jpg')}}" alt="...">
                            ...
                            <li class="media">
                                <img class="media-object" src="{{asset('backend/layouts/layout/img/avatar1.jpg')}}" alt="...">
                                <div class="media-body">
                            ...
                            <li class="media">
                                ...
                                <img class="media-object" src="{{asset('backend/layouts/layout/img/avatar4.jpg')}}" alt="...">
                                <div class="media-body">
                            ...
                            <li class="media">
                                <img class="media-object" src="{{asset('backend/layouts/layout/img/avatar2.jpg')}}" alt="...">
                                <div class="media-body">
                        ...
                        <ul class="media-list list-items">
                            <li class="media">
                                ...
                                <img class="media-object" src="{{asset('backend/layouts/layout/img/avatar6.jpg')}}" alt="...">
                                <div class="media-body">
                            ...
                            <li class="media">
                                ...
                                <img class="media-object" src="{{asset('backend/layouts/layout/img/avatar7.jpg')}}" alt="...">
                                <div class="media-body">
                            ...
                            <li class="media">
                                <img class="media-object" src="{{asset('backend/layouts/layout/img/avatar8.jpg')}}" alt="...">
                                <div class="media-body">
                            ...
                            <li class="media">
                                ...
                                <img class="media-object" src="{{asset('backend/layouts/layout/img/avatar9.jpg')}}" alt="...">
                                <div class="media-body">
                            ...
                            <li class="media">
                                <img class="media-object" src="{{asset('backend/layouts/layout/img/avatar10.jpg')}}" alt="...">
                                <div class="media-body">
                            ...
                            <li class="media">
                                ...
                                <img class="media-object" src="{{asset('backend/layouts/layout/img/avatar11.jpg')}}" alt="...">
                                <div class="media-body">
                    ...
                    <div class="page-quick-sidebar-item">
                        <div class="page-quick-sidebar-chat-user">
                            ...
                            <div class="page-quick-sidebar-chat-user-messages">
                                <div class="post out">
                                    <img class="avatar" alt="" src="{{asset('backend/layouts/layout/img/avatar3.jpg')}}" />
                                    <div class="message">
                                ...
                                <div class="post in">
                                    <img class="avatar" alt="" src="{{asset('backend/layouts/layout/img/avatar2.jpg')}}" />
                                    <div class="message">
                                        <span class="arrow"></span>
